        ...
        <div className="relative z-10 flex flex-wrap items-start justify-start gap-x-6 gap-y-6">
          ...
          <div className="space-y-5">
            <h3 className="text-sm font-medium mb-3 text-foreground/80 flex items-center">
              <Square
                className="mr-1.5 text-primary/80"
                size={16}
                strokeWidth={1.5}
              />
              Create & Add
              ...
              {!isVenueSpacePresent ? (
                <Tooltip>
                  ...
                  <TooltipContent className="bg-card text-card-foreground border-border">
                    <p>
                      First step: Add a Venue Space to define your event area
                    </p>
                  </TooltipContent>
                </Tooltip>
              ) : (
                <>
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="bg-card text-card-foreground border-border">
                      <p>
                        Add decorative elements like dance floors, bars, or
          ...
          {isVenueSpacePresent && (
            <div className="space-y-5">
              <h3 className="text-sm font-medium mb-3 text-foreground/80 flex items-center">
                <BookOpen
                  className="mr-1.5 text-secondary/80"
                  size={16}
                  strokeWidth={1.5}
                />
                Venue Controls
                  ...
                  <TooltipTrigger asChild>
                    ...
                    >
                      {isVenueSpaceLocked ? (
                        ...
                        <>
                          <Lock className="mr-2" size={18} strokeWidth={1.5} />{" "}
                          Lock Space
                        </>
                      )}
                    </Button>

...
export const DraggableGuestListItem: React.FC<DraggableGuestListItemProps> = ({
  ...
  return (
    <li
      ...
      {...listeners}
      {...attributes}
      className={`group flex items-center py-2.5 px-3 text-sm rounded-md cursor-grab transition-all duration-300 border ring-1 relative ${
        isHighlighted
    ...
    >
      ...
      <UserCircle
        ...
        strokeWidth={1.5}
      />
      <span className={`font-medium flex-grow min-w-0 ml-2 ${
        isHighlighted
          ? 'text-sidebar-primary'
